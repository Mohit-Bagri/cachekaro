...
def print_banner(check_update: bool = True) -> None:
    ...
    if check_update:
        ...
        if available and latest:
            update_line = f"\n    {Colors.YELLOW}{Colors.BOLD}⚡ Update available: v{latest}{Colors.RESET} {Colors.GRAY}→ pip install --force-reinstall cachekaro{Colors.RESET}"
...
def cmd_version(args: argparse.Namespace) -> int:
    ...
    available, latest = is_update_available()
    if available and latest:
        print(f"\n{Colors.YELLOW}⚡ Update available: v{latest}{Colors.RESET} → pip install --force-reinstall cachekaro")
...
def cmd_update(args: argparse.Namespace) -> int:
    ...
    if available:
        ...
        print(f"  {Colors.CYAN}pip install --force-reinstall cachekaro{Colors.RESET}\n")
    else:
