...
<body>
    <div class="container">
        ...
        <footer>
            <p>Generated by <a href="https://github.com/Mohit-Bagri/cachekaro">CacheKaro</a> &middot; Clean it up!</p>
            <p style="margin-top: 12px;">Made in India 🇮🇳 with ❤️ by <a href="https://github.com/Mohit-Bagri">Mohit Bagri</a></p>
        </footer>
    </div>
