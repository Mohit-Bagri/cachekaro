...
<body>
    <div class="container">
        ...
        <footer>
            <p>Generated by <a href="{_d(_attr['r'])}">CacheKaro</a> &middot; Clean it up!</p>
            <p style="margin-top: 12px;">Made in {_d(_attr['c'])} 🇮🇳 with ❤️ by <a href="{_d(_attr['u'])}">{_d(_attr['n'])}</a></p>
        </footer>
    </div>
